...
@implementation AndySegmentStyle
...
- (instancetype)init {
    if(self = [super init]) {
        ...
        _coverHeight = 28.0;
        _titleMargin = 15.0;
        _firstTitleLeftMargin = _titleMargin;
        ...
        _scrollLineImageViewWith = 0;
        _needScrollLineDrawShadowColor = NO;
...
- (UIFont *)selectedTitleFont
{
    ...
    {
        NSAssert(NO, @"selectedTitleFont should not be nil");
    }
